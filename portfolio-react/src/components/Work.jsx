          ...
          <div
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://deivi2401.github.io/budget-react/">
           ...
           {/* Grid Item */}
           <div
            style={{ backgroundImage: `url(${QRPet})` }}
            className="shadow-lg shadow-[#040c16] group container rounde-md flex justify-center items-center mx-auto content-div">
            {/*Hover effects */}
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a href="https://github.com/deivi2401/QRPET">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
                </a>
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
              <a href="https://deivi2401.github.io/portfolio-app/">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/deivi2401/portafolio">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
                </a>
