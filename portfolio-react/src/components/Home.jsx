      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <Reveal>
          <p className="text-[#8892b0] py-4 max-w-[700px]">
            ...
            non id. Officia similique eius, deleniti, cupiditate aperiam autem
            doloribus nesciunt deserunt tenetur beatae inventore nisi! Ratione
            fugit ullam laudantium veritatis?
          </p>
        </Reveal>
        <Reveal>
          <div>
